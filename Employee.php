...
<body id="body-pd">
  ...
  <form class="form-style-9" action="Employee.php" method="POST" enctype="multipart/form-data">
<ul>
<li>
    <input type="text" name="id_user" id="id_user" class="field-style field-split align-left" placeholder="Your ID" style="
    width: 100%; text-align: center;"/>

</li>
<li>
    <input type="text" name="first_Name" id="first_Name" class="field-style field-split align-left" placeholder="First Name" />
    <input type="text" name="Last_Name" id="Last_Name" class="field-style field-split align-right" placeholder="Last Name" />
</li>
<li>
<input placeholder="Date" type="text" id="Datesi" name="Date" onfocus="(this.type='date')" class="field-style field-full align-none" placeholder="Subject" />
</li>
<li>
    <input type="text" id="Salary" name="Salary" class="field-style field-split align-left" class="field-style field-full align-none" placeholder="Salary" />
...
<li>
    <input type="text" name="Department" class="field-style field-split align-left" placeholder="Department" style="
    width: 100%; text-align: center;" />
...
<a>
      ...
      <span></span>
      <span></span>
<input  type="submit" name="Submit" value="S U B M I T" id="Submit" style="FONT-SIZE: 133%;COLOR: #03e9f4;"> 
...
if (empty($_POST['id_user']) || empty($_POST['first_Name']) || empty($_POST['Last_Name']) || empty($_POST['Date']) || empty($_POST['Salary']) || empty($_POST['Department']) || empty($_POST['Function']) || $_FILES['Image']['name'] == "" ) {
    ...
    $insert = "INSERT INTO `employee`(`id_user`, `first_Name`, `Last_Name`, `Date`, `Salary`, `Function`, `Department`, `Image`) VALUES ('$id_user','$first_Name','$Last_Name','$Date','$Salary','$Function','$Department','$Image')";
    
    $uplod = mysqli_query($conn,$insert);
